            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <select class="form-control form-control-light" name="milestone_id" id="task-milestone">
                        ...
                        $__env->addLoop($__currentLoopData);
                        foreach ($__currentLoopData as $milestone) : $__env->incrementLoopIndices();
                            $loop = $__env->getLastLoop(); ?>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <select class="form-control form-control-light" id="assign_to" name="assign_to" required>
                        ...
                        $__env->addLoop($__currentLoopData);
                        foreach ($__currentLoopData as $u) : $__env->incrementLoopIndices();
                            $loop = $__env->getLastLoop(); ?>
...
<?php endif; ?>
<?php /**PATH D:\MIJOB\MIJOB\resources\views/projects/taskCreate.blade.php ENDPATH**/ ?>