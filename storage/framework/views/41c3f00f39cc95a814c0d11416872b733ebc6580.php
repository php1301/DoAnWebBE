...
<?php if($project && $currentWorkspace && $task): ?>
    ...
    <form class="pl-3 pr-3" method="post" action="<?php echo e(route('tasks.update',[$currentWorkspace->slug,$project->id,$task->id])); ?>">
        <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\BUIQUOCHUY\Desktop\WEBEZJOB\DoAnWebBE\resources\views/projects/taskEdit.blade.php ENDPATH**/ ?>