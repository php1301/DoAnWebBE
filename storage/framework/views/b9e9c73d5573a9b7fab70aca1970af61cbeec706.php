            ...
            <div class="col-sm-8">
                <div class="text-sm-right">
                    <div class="btn-group mt-4">
                        <a href="<?php echo e(route('projects.task.board',[$currentWorkspace->slug,$project->id])); ?>" class="btn btn-primary"><?php echo e(__('Task Board')); ?></a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-8 animated">
                ...
                <div class="card author-box card-primary">
                    <div class="card-body">
                        <div class="card-header-action">
                            <div class="dropdown card-widgets">
                                <a href="#" class="btn btn-sm btn-primary" data-ajax-popup="true" data-title="<?php echo e(__('Create Milestone')); ?>" data-url="<?php echo e(route('projects.milestone',[$currentWorkspace->slug,$project->id])); ?>"><?php echo e(__('Create Milestone')); ?></a>
                            </div>
                        </div>
                        <!-- project title-->
                            ...
                            <div class="ribbon-wrapper  bg-white b-all mb-4 milestones">
                                ...
                                <div class="ribbon-content">
                                    <h5 class="media-heading text-info font-light">
                                        <a href="#" class="milestone-detail" data-ajax-popup="true" data-title="<?php echo e(__('Milestones Details')); ?>" data-url="<?php echo e(route('projects.milestone.show',[$currentWorkspace->slug,$milestone->id])); ?>"><?php echo e($milestone->title); ?></a>
                                        <div class="float-right">
                                            <small>
                                                <a href="#" class="btn btn-sm btn-outline-primary" data-ajax-popup="true" data-title="<?php echo e(__('Edit Milestone')); ?>" data-url="<?php echo e(route('projects.milestone.edit',[$currentWorkspace->slug,$milestone->id])); ?>"><i class="mdi mdi-pencil"></i></a>
...
window.onload = function() {
    ...
    <script>
        ...
        dropzoneBtn(mockFile,{download:"<?php echo e(route('projects.file.download',[$currentWorkspace->slug,$project->id,$file->id])); ?>",delete:"<?php echo e(route('projects.file.delete',[$currentWorkspace->slug,$project->id,$file->id])); ?>"});

        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\BUIQUOCHUY\Desktop\WEBEZJOB\DoAnWebBE\resources\views/projects/show.blade.php ENDPATH**/ ?>