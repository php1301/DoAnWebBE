                    ...
                    <div class="card profile-widget">
                        ...
                        <div class="profile-widget-description pb-0">
                            <div class="card-body p-0">
                                ...
                                <div class="profile-widget-name"><?php echo e($user->name); ?> <div class="text-muted d-inline font-weight-normal">
                                        <div class="slash"></div> <?php echo e($user->permission); ?>
                                    </div>
                                </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\MIJOB\resources\views/users/index.blade.php ENDPATH**/ ?>