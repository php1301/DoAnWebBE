            ...
            <div class="col-md-8 animated">
                ...
                <div class="card author-box card-primary">
                    <div class="card-body">
                        ...
                        <div>
                            ...
                            <?php $__currentLoopData = $project->users;
                ...
                <div class="card author-box card-primary">
                    <div class="card-body">
                        ...
                        <?php $__currentLoopData = $project->milestones;
                        $__env->addLoop($__currentLoopData);
                        foreach ($__currentLoopData as $key => $milestone) : $__env->incrementLoopIndices();
                            $loop = $__env->getLastLoop(); ?>
                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body" style="height: 500px;overflow-y: scroll">
                        <div class="activities">
                            <?php $__currentLoopData = $project->activities;
                            $__env->addLoop($__currentLoopData);
...
<script>
    ...
    foreach ($__currentLoopData as $file) : $__env->incrementLoopIndices();
        ...
        var mockFile = {
            ...
            size: <?php echo e(filesize(storage_path('project_files/' . $file->file_path))); ?>
        };
        ...
        dropzoneBtn(mockFile, {
            download: "<?php echo e(route('projects.file.download', [$currantWorkspace->slug, $project->id, $file->id])); ?>",
            delete: "<?php echo e(route('projects.file.delete', [$currantWorkspace->slug, $project->id, $file->id])); ?>"
        });
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\MIJOB\MIJOB\resources\views/projects/show.blade.php ENDPATH**/ ?>