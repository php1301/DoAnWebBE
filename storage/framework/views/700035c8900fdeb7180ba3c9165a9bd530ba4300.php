...
<?php if($project && $currentWorkspace): ?>
    ...
    <form class="pl-3 pr-3" method="post" action="<?php echo e(route('projects.milestone.store',[$currentWorkspace->slug,$project->id])); ?>">
        <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\BUIQUOCHUY\Desktop\WEBEZJOB\DoAnWebBE\resources\views/projects/milestone.blade.php ENDPATH**/ ?>