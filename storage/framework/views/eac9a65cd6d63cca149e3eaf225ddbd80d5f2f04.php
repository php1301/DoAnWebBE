            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-8">
                    <div class="text-sm-right">
                        <button type="button" class="btn btn-primary btn-rounded mt-4" data-ajax-popup="true" data-size="lg" data-title="<?php echo e(__('Create New Note')); ?>" data-url="<?php echo e(route('notes.create',$currentWorkspace->slug)); ?>">
                                    ...
                                    <div class="card mb-0 mt-3 text-white <?php echo e($note->color); ?>">
                                        <div class="card-body">
                                            <div class="card-widgets float-right">
                                                <a href="#" data-ajax-popup="true" data-size="lg" data-title="<?php echo e(__('Edit Note')); ?>" data-url="<?php echo e(route('notes.edit',[$currentWorkspace->slug,$note->id])); ?>"><i class="mdi mdi-pencil"></i></a>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\BUIQUOCHUY\Desktop\WEBEZJOB\DoAnWebBE\resources\views/notes/index.blade.php ENDPATH**/ ?>