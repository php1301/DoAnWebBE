...
<section class="section">
    ...
    <?php if($currentWorkspace || Auth::user()->type == 'admin'): ?>
        ...
        <div class="row mb-2">
            ...
            <?php if($currentWorkspace && $currentWorkspace->creater->id == Auth::user()->id): ?>
            <div class="col-sm-8">
                <div class="text-sm-right">
                    <button type="button" class="btn btn-primary btn-rounded mt-4" data-ajax-popup="true" data-size="lg" data-title="<?php echo e(__('Invite New User')); ?>" data-url="<?php echo e(route('users.invite',$currentWorkspace->slug)); ?>">
                        ...
                        <div class="profile-widget-items">
                            ...
                            <?php if(Auth::user()->type == 'admin'): ?>
                                ...
                                <div class="profile-widget-item">
                                    ...
                                    <div class="profile-widget-item-value"><?php echo e($user->countUsers(($currentWorkspace)?$currentWorkspace->id:'')); ?></div>
                                </div>
                              
                            <?php endif; ?>
                            <div class="profile-widget-item">
                                <div class="profile-widget-item-label"><?php echo e(__('Number of Projects')); ?></div>
                                <div class="profile-widget-item-value"><?php echo e($user->countProject(($currentWorkspace)?$currentWorkspace->id:'')); ?></div>
                            </div>
                            <?php if(Auth::user()->type != 'admin'): ?>
                                <div class="profile-widget-item">
                                    <div class="profile-widget-item-label"><?php echo e(__('Number of Tasks')); ?></div>
                                    <div class="profile-widget-item-value"><?php echo e($user->countTask(($currentWorkspace)?$currentWorkspace->id:'')); ?></div>
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
                        ...
                        <div class="card-body p-0">
                            <div class="card-header-action">
                                <div class="dropdown card-widgets text-right">
                                    <?php if($currentWorkspace->permission == 'Owner' && Auth::user()->id != $user->id): ?>
                                        <div class="dropdown card-widgets float-right">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a href="#" class="dropdown-item" data-ajax-popup="true" data-size="lg" data-title="<?php echo e(__('Edit User')); ?>" data-url="<?php echo e(route('users.edit',[$currentWorkspace->slug,$user->id])); ?>"><i class="mdi mdi-pencil mr-1"></i><?php echo e(__('Edit')); ?></a>
                                                ...
                                                <form method="post" id="delete-form-<?php echo e($user->id); ?>" action="<?php echo e(route('users.remove',[$currentWorkspace->slug,$user->id])); ?>">
                                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\BUIQUOCHUY\Desktop\WEBEZJOB\DoAnWebBE\resources\views/users/index.blade.php ENDPATH**/ ?>