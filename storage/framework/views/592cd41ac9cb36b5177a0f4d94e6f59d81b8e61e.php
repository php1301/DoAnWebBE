<form class="pl-3 pr-3" method="post" action="<?php echo e(route('notes.store',$currentWorkspace->slug)); ?>">
    <?php echo csrf_field(); ?>
...
</form><?php /**PATH C:\Users\BUIQUOCHUY\Desktop\WEBEZJOB\DoAnWebBE\resources\views/notes/create.blade.php ENDPATH**/ ?>