...
<ul class="navbar-nav navbar-right">
  ...
  <li class="dropdown dropdown-list-toggle">
    <a href="#" data-toggle="dropdown" class="nav-link notification-toggle nav-link-lg">
      <span class="align-middle"><?php echo e(Str::upper($currentLang)); ?></span>
    ...
    <div class="dropdown-menu dropdown-list dropdown-menu-right">
      <?php $__currentLoopData = $currentWorkspace->languages(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <!-- item-->
          <a href="<?php echo e(route('change_lang_workspace',[$currentWorkspace->id,$lang])); ?>" class="dropdown-item">
  ...
  <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
    ...
    <div class="dropdown-menu dropdown-menu-right">
      <?php $__currentLoopData = Auth::user()->workspace; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $workspace): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          ...
          <a href="<?php if($currentWorkspace->id == $workspace->id): ?>#<?php else: ?><?php echo e(route('change_workspace',$workspace->id)); ?><?php endif; ?>" title="<?php echo e($workspace->name); ?>" class="dropdown-item notify-item">
      ...
      <?php if(isset($currentWorkspace) && $currentWorkspace): ?>
        <?php if(Auth::user()->id == $currentWorkspace->created_by): ?>
          ...
          <form id="remove-workspace-form" action="<?php echo e(route('delete_workspace', ['id' => $currentWorkspace->id])); ?>" method="POST" style="display: none;">
            <?php echo csrf_field(); ?>
        ...
        <?php else: ?>
          ...
          <form id="remove-workspace-form" action="<?php echo e(route('leave_workspace', ['id' => $currentWorkspace->id])); ?>" method="POST" style="display: none;">
            <?php echo csrf_field(); ?>
            <?php echo method_field('DELETE'); ?>
          </form>
        <?php endif; ?>
...
<?php /**PATH C:\Users\BUIQUOCHUY\Desktop\WEBEZJOB\DoAnWebBE\resources\views/partials/topnav.blade.php ENDPATH**/ ?>