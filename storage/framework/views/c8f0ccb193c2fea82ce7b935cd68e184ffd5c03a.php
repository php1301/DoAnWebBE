<form class="pl-3 pr-3" method="post" action="<?php echo e(route('projects.update',[$currentWorkspace->slug,$project->id])); ?>">
    <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Users\BUIQUOCHUY\Desktop\WEBEZJOB\DoAnWebBE\resources\views/projects/edit.blade.php ENDPATH**/ ?>