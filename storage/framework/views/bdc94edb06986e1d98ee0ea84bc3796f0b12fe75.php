            ...
            <div class="text-sm-right">
                <div class="btn-group mt-4">
                    <?php if ($currantWorkspace && $currantWorkspace->permission == 'Owner') : ?>
                        <a href="#" class="btn btn-primary ml-3" data-ajax-popup="true" data-size="lg" data-title="<?php echo e(__('Create New Task')); ?>" data-url="<?php echo e(route('tasks.create', [$currantWorkspace->slug, $project->id])); ?>"><i class="mdi mdi-plus"></i> <?php echo e(__('Add New')); ?></a>
                    <?php endif; ?>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="board" data-plugin="dragula" data-containers='<?php echo e(json_encode($statusClass)); ?>'>
                    ...
                    foreach ($__currentLoopData as $status => $task) : $__env->incrementLoopIndices();
                        ...
                        <div class="tasks animated">
                            ...
                            <div id="<?php echo e('task-list-' . str_replace(' ', '_', $status)); ?>" data-status="<?php echo e($status); ?>" class="task-list-items">
                                <?php $__currentLoopData = $task;
                                $__env->addLoop($__currentLoopData);
                                foreach ($__currentLoopData as $taskDetail) : $__env->incrementLoopIndices();
                                    $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\MIJOB\MIJOB\resources\views/projects/taskboard.blade.php ENDPATH**/ ?>