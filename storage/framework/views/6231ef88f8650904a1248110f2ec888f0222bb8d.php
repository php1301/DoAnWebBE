        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-8">
                ...
                <div class="text-sm-right">
                    <button type="button" class="btn btn-primary btn-rounded mt-4" style="border-color: green data-ajax-popup="true" data-size="lg" data-title="<?php echo e(__('Add Client')); ?>" data-url="<?php echo e(route('clients.create',$currantWorkspace->slug)); ?>">
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Phat trien ung dung web\DoAnWebBE\resources\views/clients/index.blade.php ENDPATH**/ ?>