                    ...
                    <div class="btn-group mt-4">
                        <?php if($currentWorkspace && $currentWorkspace->permission == 'Owner'): ?>
                            <a href="#" class="btn btn-primary ml-3" data-ajax-popup="true" data-size="lg"
                               ...
                               data-url="<?php echo e(route('tasks.create',[$currentWorkspace->slug,$project->id])); ?>"><i class="mdi mdi-plus"></i> <?php echo e(__('Add New')); ?></a>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\BUIQUOCHUY\Desktop\WEBEZJOB\DoAnWebBE\resources\views/projects/taskboard.blade.php ENDPATH**/ ?>