                                ...
                                <div class="card-body p-3">
                                    <div class="dropdown float-right">
                                        ...
                                        <?php if($currentWorkspace->permission === 'Owner'): ?>
                                                <a href="#" class="dropdown-item" data-ajax-popup="true" data-size="lg" data-title="<?php echo e(__('Edit Task')); ?>" data-url="<?php echo e(route('tasks.edit',[$currentWorkspace->slug,$taskDetail->project_id,$taskDetail->id])); ?>">
                                                ...
                                                <form id="delete-form-<?php echo e($taskDetail->id); ?>" action="<?php echo e(route('tasks.destroy',[$currentWorkspace->slug,$taskDetail->project_id,$taskDetail->id])); ?>" method="POST" style="display: none;">
                                                    <?php echo csrf_field(); ?>
                        ...
                        t.prototype.init = function () {
                            a('[data-plugin="dragula"]').each(function () {
                                ...
                                r ? dragula(n, {
                                    ...
                                    $.ajax({
                                        url:'<?php echo e(route('tasks.update.order',[$currentWorkspace->slug,$project->id])); ?>',
                                        type:'PUT',
            ...
            <?php /**PATH C:\Users\BUIQUOCHUY\Desktop\WEBEZJOB\DoAnWebBE\resources\views/projects/tasklist.blade.php ENDPATH**/ ?>