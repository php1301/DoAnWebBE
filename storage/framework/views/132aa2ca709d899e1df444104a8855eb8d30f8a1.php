        ...
        <div class="tab-content">
            <div class="tab-pane show active" id="home-b1">
                ...
                <div class="card-body">
                    <ul class="list-unstyled list-unstyled-border" id="comments">
                        ...
                        <?php $__currentLoopData = $task->comments;
                        $__env->addLoop($__currentLoopData);
                        foreach ($__currentLoopData as $comment) : $__env->incrementLoopIndices();
                            $loop = $__env->getLastLoop(); ?>
                            <li class="media">
                                <img class="mr-3 avatar-sm rounded-circle img-thumbnail" width="60" <?php if ($comment->user_type != 'Client') : ?> <?php if ($comment->user->avatar) : ?> src="<?php echo e(asset('/storage/avatars/' . $comment->user->avatar)); ?>" <?php else : ?> avatar="<?php echo e($comment->user->name); ?>" <?php endif; ?> alt="<?php echo e($comment->user->name); ?>" <?php else : ?> avatar="<?php echo e($comment->client->name); ?>" alt="<?php echo e($comment->client->name); ?>" <?php endif; ?> />
            ...
            <div class="tab-pane" id="profile-b1">
                ...
                <div id="comments-file" class="mt-2">
                    <?php $__currentLoopData = $task->taskFiles;
                    $__env->addLoop($__currentLoopData);
                ...
                <div class="tab-pane show" id="sub-task">
                    ...
                    <div class="card-body p-1">
                        <ul class="list-group" id="subtasks">
                            ...
                            <?php $__currentLoopData = $task->sub_tasks;
                            $__env->addLoop($__currentLoopData);
                            foreach ($__currentLoopData as $subTask) : $__env->incrementLoopIndices();
                                $loop = $__env->getLastLoop(); ?>
...
<?php endif; ?>
<?php /**PATH D:\MIJOB\MIJOB\resources\views/projects/taskShow.blade.php ENDPATH**/ ?>